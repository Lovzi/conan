...
class User(AbstractUser):
    ...
    group = models.ForeignKey(Group, related_name="users", on_delete=models.SET_NULL, blank=True, null=True)
...
class Contest(models.Model):
    ...
    created_by = models.ForeignKey(User, related_name="created_contests", on_delete=models.DO_NOTHING)
...
class Problem(models.Model):
    ...
    source = models.CharField('来源', max_length=254, blank=True)
    tip = models.TextField('提示', blank=True)
    visible = models.BooleanField('是否显示', default=True)
    created_time = models.DateTimeField(auto_now_add=True)
    contest = models.ForeignKey(Contest, null=True, related_name="problems", on_delete=models.SET_NULL)
    created_by = models.ForeignKey(User, related_name="created_problems", on_delete=models.DO_NOTHING)
...
class AbstractComment(models.Model):
    ...
    reply = models.ForeignKey(settings.AUTH_USER_MODEL, verbose_name='回复', related_name='%(class)s_replied',null=True, on_delete=models.CASCADE)
    parent_comment = models.ForeignKey('self', verbose_name="上级评论",null=True, related_name="children_comments", on_delete=models.CASCADE)
