# Generated by Django 2.1.7 on 2019-04-17 20:01
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='DoubtComment',
            fields=[
                ('abstractcomment_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='common.AbstractComment')),
            ],
            options={
                'verbose_name': '帖子评论',
        ...
        migrations.AddField(
            ...
            name='author',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='abstractcomment', to=settings.AUTH_USER_MODEL, verbose_name='作者'),
        ),
        migrations.AddField(
            model_name='abstractcomment',
            name='parent_comment',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='children_comments', to='common.AbstractComment', verbose_name='上级评论'),
        ),
        migrations.AddField(
            model_name='abstractcomment',
            name='reply',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='abstractcomment_replied', to=settings.AUTH_USER_MODEL, verbose_name='回复'),
        ),
        migrations.AddField(
            model_name='user',
            name='group',
        ...
        migrations.AddField(
            ...
            name='problem',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='common.Problem', verbose_name='问题'),
        ),
        migrations.AddField(
            model_name='doubtcomment',
            name='doubt',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='common.Doubt', verbose_name='帖子'),
        ),
    ]
