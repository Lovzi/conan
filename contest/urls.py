...
urlpatterns = [
    ...
    path(r'apply/cancel/', views.ContestApplyCancel.as_view(), name='cancel'),
    path(r'cancel/', views.ContestCancel.as_view(), name='cancel'),
    ...
    path(r'<int:contest_id>/', views.ContestView.as_view()),
    path(r'<int:contest_id>/detail/', views.ContestDetailView.as_view()),
    path(r'<int:contest_id>/problems/<int:problem_id>/',
